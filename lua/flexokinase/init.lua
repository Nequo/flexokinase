...
vim.g["colors_name"] = "flexokinase"
vim.o["termguicolors"] = true

local p = require('flexokinase.colors')
...
hl(0, "StatusLine", {fg = c.base00, bg = c.blue})
...
hl(0, "MatchParen", {fg = c.magenta, bg = c.base02, underline = true})
hl(0, "IncSearch", {fg = c.base01, bg = c.magenta})
hl(0, "Search", {fg = c.base01, bg = c.yellow})
...
hl(0, "Comment", {fg = c.gray, bg = c.none, italic = true})
...
hl(0, "Exception", {fg = c.blue, bg = c.none})
...
hl(0, "Operator", {fg = c.cyan, bg = c.none})
...
hl(0, "@exception.zig", {fg = c.blue, bg = c.none})
hl(0, "@function.builtin.zig", {fg = c.yellow, bg = c.none})
